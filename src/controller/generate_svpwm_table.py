...
results = map(lambda pwms: map_pwm(pwms, 0, maximum_uncapped_pwm_period, -PWM_AMPLITUDE, PWM_AMPLITUDE), uncapped_pwm)
...
results = results[0:128] + list(map(lambda x: 0-x, results[128:]))
